...
function Buttons ({ buttons, onButtonClicked, selected, containerStyle, buttonStyle, buttonSelectedStyle }) {
    return (
        <div className={'flex flex-row justify-center flex-wrap px-5'} style={containerStyle}>
            {
                buttons.map(button => {
                    return (
...
function MenuButtons ({ buttons, onButtonClicked, selected }) {
    ...
    }, [theme.booleans.stickButtons, theme.booleans.stickButtonsMenu, theme.booleans.stickNavBar]);
