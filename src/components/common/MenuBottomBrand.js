...
function MenuBottomBrand ({ title, image, style }) {
    ...
    return (
        <div className='flex flex-col items-center justify-end full-w pb-20 md:py-5' style={theme.common.bottomBrandStyle}>
            ...
            <div className='text-center text-xs' style={theme.common.bottomBrandTextInfoStyle}>
                <a className='block' href={info.location.googleMapsUrl} target="_blank" rel="noopener noreferrer">
                    <FormattedAddress />
