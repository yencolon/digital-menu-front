  ...
  return (
    ...
    >
        ...
        <img
          ...
          className={`${
            !theme.booleans.showNavTopIcons
              ? 'justify:left ml-6 w-4/5 md:w-64 py-2'
              : 'h-150 w-150 py-2 ml-2'
          }`}
          height={120}
          width={120}
        />
      ...
      <div className="hidden lg:block lg:justify-end">
        <NavLink
          to={`${url}/`}
          className="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-white mr-5 font-normal"
          activeStyle={{}}
        >
          Menú
        </NavLink>
      ...
      {theme.booleans.showNavTopIcons ? (
        <div className="lg:hidden flex justify-end flex-grow">
          <a
            href="https://goo.gl/maps/u57TnknURpbaNg7y8"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/haptico.menu"
            target="_blank"
            rel="noopener noreferrer"
            className="mr-8"
          >
