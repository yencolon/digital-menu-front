  ...
  return (
    <CurrentRestaurantInfoStateContext.Provider value={context}>
      <CurrentRestaurantInfoDispatchContext.Provider
        value={currentRestaurantInfoContextUpdater}
      >
        {children}
      </CurrentRestaurantInfoDispatchContext.Provider>
...
const useCurrentRestaurantState = () => {
  ...
  if (context === undefined) {
    throw new Error(
      'useCurrentRestaurantState must be used within a CurrentRestaurantStateProvider'
    );
  }
  return context;
};
...
const useCurrentRestaurantDispatch = () => {
  ...
  if (context === undefined) {
    throw new Error(
      'useCurrentRestaurantDispatch must be used within a CurrentRestaurantDispatchProvider'
    );
  }
  return context;
};
...
export {
  ...
  useCurrentRestaurantState,
  useCurrentRestaurantDispatch,
};
